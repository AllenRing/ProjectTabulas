...
try:
    while cycling:
        ...
        if((roll > 0) and (motorThreeSpeed > 180) and (motorTwoSpeed > 180)):       # tilted right
            if(rollV > 0):      #Drone tilting right
                ...
                if(roll > (Mark / float(2))):   # if roll is greater than half mark
                    Right += 1
                
                if(roll < (Mark / float(2))):    # if roll is lessthan half mark
                    Right += -1
                
        elif((roll < 0) and (motorOneSpeed > 180) and (motorFourSpeed > 180)):     #Drone tilted left
