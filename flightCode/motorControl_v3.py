...
try:
    while cycling:
        ...
        if(change > 180):
            change = change * 100
            change = change / float(180)
            change = change - 100
            change = 100 - change
        #end of if
        
        
        Tpercent = (change * 100) / float(180)
        RTurn = MaxTurn * Tpercent
        if(heading > 180):
            Rturn *= -1
        ...
        motorTwoSpeed = Back + Right + strength + RTurn
        motorFourSpeed = Back + Left + strength - RTurn
        motorThreeSpeed = Front + Right + strength  - RTurn
        motorOneSpeed = Front + Left + strength + RTurn
        """
