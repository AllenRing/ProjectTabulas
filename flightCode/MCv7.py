...
strength = 216     #Sets base strength of motors
OldRoll = 0
OldRoll2 = 0
OldPitch = 0
OldPitch2 = 0
    ...
    while cycling:
        ...
        if(roll > 0):       # tilted right
            if(rollV > 0):      #Drone tilting right
                ...
                if(roll > (RMark / float(2))):   # if roll is greater than half RMark
                    Right += 1
                elif(roll < (RMark / float(2))):    # if roll is lessthan half RMark
                    Right += -1
        ...
        if(pitch > 0):      # nose tilted upward
            if(pitchV > 0): # nose tilting upward
                ...
                if(pitch > (PMark / float(2))):     # if greater than half way point
                    Front += -1            
                elif(pitch < (PMark / float(2))):   # if less than half way point
                    Front += 1              
        ...
        OldPitch2 = OldPitch
        OldPitch = pitch
        #time.sleep(.5)     # possible use in future for delay if ethan's idea doesnt work
