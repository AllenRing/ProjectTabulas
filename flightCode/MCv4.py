...
try:
    while cycling:
        ...
        #   Roll positive = Tilting to the right
        #   Pitch pisitive = drone nose up
        ...
        motorTwoSpeed += Back + Right
        motorFourSpeed += Back + Left
        motorThreeSpeed += Front + Right
        motorOneSpeed += Front + Left
